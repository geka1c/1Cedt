...
//	СтоСПОбмен_Общий.ОтразитьСтоСПОбмен(ДополнительныеСвойства, Движения, Отказ);
	...
	//		Движение.Списано		= Списать;
	//		Движение.ТипРасхода		=?(Списать,Перечисления.ТипРасхода.Списано,Перечисления.ТипРасхода.Расход);
	//		Движение.Покупка 		= ТекСтрока.Покупка;
	//		Движение.ПокупкаСпр		= ТекСтрока.ПокупкаСпр;
	//		Движение.Количество 	= ТекСтрока.Количество;
	//		Движение.Сумма			= ?(Списать,0,ТекСтрока.СтоимостьИтого);	    		
	//
	//КонецЦикла;
	
	//Если ПоискНикаСтоимость<>0 и не Списать Тогда
	//		Движение 				= Движения.Расход.Добавить();
	//		Движение.Период 		= Дата;
	//		//Движение.Габарит 	 	= ТекСтрока.Габарит;
	//		Движение.Участник 		= Участник;
	...
	//		Движение.ТипРасхода		=?(Списать,Перечисления.ТипРасхода.Списано,Перечисления.ТипРасхода.Расход);
	//		Движение.Покупка 		= -1;
	//		Движение.ПокупкаСпр		= "За поиск ника";
	//		Движение.Количество 	= 0;
	//		Движение.Сумма			= ПоискНикаСтоимость;	    		
	//КонецЕсли;
