...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	НачалоЗагрузкиСупергрупп 	= Константы.ПоследняяЗагрузкаСупергрупп.Получить();
	НачалоЗагрузкиПосылок	 	= Константы.ПоследняяЗагрузкаПосылок.Получить();
	НачалоЗагрузкиГруппДоставки	= Константы.ПоследняяЗагрузкаГруппОбъединеннойДоставки.Получить();
	НачалоЗагрузкиТранзитов		= ТекущаяДата() - 10*60*60*24;
	
	НачалоЗагрузкиУчастников	= Константы.ПоследняяЗагрузкаУчастников.Получить();
	НачалоЗагрузкиПокупок		= Константы.ПоследняяЗагрузкаПокупок.Получить();
