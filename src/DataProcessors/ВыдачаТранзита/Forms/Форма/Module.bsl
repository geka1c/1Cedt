...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия="ВыдачаТранзита" Тогда
		...
		//
		//форма=ПолучитьФорму("Документ.ВыдачаТранзита.ФормаОбъекта");
		//ДанныеФормы=форма.Объект;
		//ЗаполнитьНаСервере(Параметр,ДанныеФормы);
	...
	ИначеЕсли ИмяСобытия="УпаковатьЗаказы" Тогда
		...
		//
		//форма=ПолучитьФорму("Документ.УпаковатьЗаказы.ФормаОбъекта");
		//ДанныеФормы=форма.Объект;
		//ЗаполнитьНаСервере(Параметр,ДанныеФормы);
		//КопироватьДанныеФормы(ДанныеФормы, Форма.Объект);
		//Форма.Открыть();
